...
- (id)initWithAnnotation:(id <MKAnnotation>)annotation reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self != nil)
    {
        ...
        self.annotationImage = [UIImage imageNamed:hotelAnnotation.imageName];
        
        NSString *priceString = (hotelAnnotation.price) == 0 ? @"已售完" : [[NSString alloc] initWithFormat:NSLocalizedString(@"￥%d", nil), hotelAnnotation.price];
