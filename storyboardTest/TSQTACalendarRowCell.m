...
- (UIImage *)startSelectedBackgroundImage
{
    return [[UIImage imageNamed:@"CalendarStartSelected.png"] stretchableImageWithLeftCapWidth:0 topCapHeight:0];
    
}
- (UIImage*)backSelectedBackgroundImage
{
    return [[UIImage imageNamed:@"CalendarBackSelected.png"] stretchableImageWithLeftCapWidth:0 topCapHeight:0];
}
...
- (BOOL)needTextYesterday
{
    return NO;
}
- (BOOL)needTextTomorrow
{
    return NO;
}
