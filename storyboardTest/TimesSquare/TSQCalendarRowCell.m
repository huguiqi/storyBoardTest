...
//        [self createNotThisMonthButtons];
    ...
    NSDateComponents *tomorrowDateComponents = [self compareDateComponents:1];
    NSDateComponents *laterDateComponents = [self compareDateComponents:2];
...
//            [self.notThisMonthButtons[index] setHidden:NO];
            ...
            if ([self.todayDateComponents isEqual:thisDateComponents]) {
                ...
                [self.todayButton setTitle:@"今" forState:UIControlStateNormal];
                [self.todayButton setAccessibilityLabel:accessibilityLabel];
                self.indexOfTodayButton = index;
            }else if([tomorrowDateComponents isEqual:thisDateComponents]){
                [self.dayButtons[index] setTitle:@"明" forState:UIControlStateNormal];
                [self.dayButtons[index] setAccessibilityLabel:accessibilityLabel];
                [self.dayButtons[index] setHidden:NO];
            }else if([laterDateComponents isEqual:thisDateComponents]){
                [self.dayButtons[index] setTitle:@"后" forState:UIControlStateNormal];
                [self.dayButtons[index] setAccessibilityLabel:accessibilityLabel];
                [self.dayButtons[index] setHidden:NO];
            }else {
...
-(NSDateComponents *)compareDateComponents:(NSInteger)day{
    ...
    NSDateComponents *compareDateComponents = [self.calendar components:NSDayCalendarUnit|NSMonthCalendarUnit|NSYearCalendarUnit fromDate:tempDate];
