 ...
 *选中出发
 */
@property (nonatomic, weak, readonly) UIImage *startSelectedBackgroundImage;

/*
 *选中返回
 */
@property (nonatomic, weak, readonly) UIImage *backSelectedBackgroundImage;

/*
 *今天文本颜色
 */
@property (nonatomic, weak, readonly) UIColor *todayColor;

/*
 *昨天文本颜色
 */
@property (nonatomic, weak, readonly) UIColor *yesterDayColor;

/*
 *明天文本颜色
 */
@property (nonatomic, weak, readonly) UIColor *tomorrowColor;

/*
 *节日颜色
 */
@property (nonatomic, weak,readonly)  UIColor *festivalColor;

/*
 *是否需要用文字表示昨天，今天，明天
 */
@property (nonatomic,assign,readonly) BOOL needTextToday;
@property (nonatomic,assign,readonly) BOOL needTextYesterday;
@property (nonatomic,assign,readonly) BOOL needTextTomorrow;
